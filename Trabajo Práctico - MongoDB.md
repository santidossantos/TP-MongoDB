...
```jsx
db.products.updateOne({name: {$eq: "Fideos Marolio t"}}, 
{$set: { price: 530}})
```
...
Esto nos indica que existe un indice de un solo campo y se esta indexando la clave de la colección products.
...
| Cantidad de documentos examinados en un ensayo | 45341 | 2203 |
- Observación
...
- Ejemplo de la ejecución sin indice
    ...
    executionSuccess: true,
        ...
        totalKeysExamined: 0,
        totalDocsExamined: 45341,
    ```
    
- Ejemplo de la ejecución con indice
    
    ```jsx
    executionSuccess: true,
        nReturned: 2203,
        executionTimeMillis: 52,
        totalKeysExamined: 45341,
...
Utilizamos el índice geoespacial en la colección purchases ya creado anteriormente en el ejercicio 13, ya que es necesario para utilizar la operación $geoNear.
...
- Observación
    ...
    Como el enunciado no especifica que es lo que se debe proyectar a la salida, se optó por proyectar todos los campos.